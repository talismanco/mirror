...
const (
	...
	// TemplateDirName is the name of the directory that contains the template files in a mirror template
...
// Configuration contains the values for needed for mirror to operate.
// These values can be overridden by the inclusion of a config.json
...
func init() {
	...
	// Read .config/mirror/config.json if exists
